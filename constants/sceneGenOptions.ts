...
export const SCENE_TEMPLATES: SceneTemplate[] = [
    ...
    },
    {
        id: 'snow_triptych',
        name: '雪景 (Snow)',
        description: '水平雪景冬季构图，包含特写细节。上段：眼睛特写，睫毛和头发上有雪。',
        params: {
            characterAge: 22,
            characterType: 'young_woman',
            ethnicity: 'east_asian',
            ...
            surface: 'grass',
            props: [],
            customProps: 'transparent vinyl umbrella, thick coat, voluminous knit scarf, falling snow, vast snowfield',
            cameraAngle: 'eye_level',
            shotType: 'close_up',
            photoStyle: 'portrait',
            quality: '8k',
            lightingType: 'soft_light',
            timeOfDay: 'afternoon',
            weather: 'snowy',
            atmosphere: 'peaceful'
        }
    },
    {
        id: 'nine_grid',
        name: '九宫格 (Nine-Grid)',
        description: '3x3 Photo Booth Grid, 不同的姿势和表情',
        params: {
            characterAge: 22,
            characterType: 'young_woman',
            ethnicity: 'east_asian',
    ...
    },
    {
        id: 'four_panel',
        name: '四连拍 (Four-Panel)',
        description: '4-panel composition: Close-up, Yawning, Back view, Selfie',
        params: {
            characterAge: 22,
            characterType: 'young_woman',
            ethnicity: 'east_asian',
    ...
    {
        id: 'doodle_bombing',
        name: '涂鸦轰炸 (Doodle Bombing)',
        description: '混合媒介风格：超写实摄影 + 2D卡通涂鸦',
        params: {
            characterAge: 20,
            characterType: 'young_woman',
            ethnicity: 'east_asian',
            ...
            surface: 'concrete',
            props: [],
            customProps: 'graffiti_alley', // Default background ID
            cameraAngle: 'eye_level',
            shotType: 'medium_shot',
            photoStyle: 'fashion',
            quality: '8k',
